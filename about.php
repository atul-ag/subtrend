	...
	<main>
		<div class="container">
			<div class="row">
				...
				One could easily use developer tool to Inspect that part. So on insepection we get a link "<i>https://www.codechef.com/ssubmission/prob?page=[page_no]&pcode=[problem_code]&ccode=[contest_code]</i> ".
